...
document.addEventListener('mousemove', (e) => {
    const cards = document.querySelectorAll('.card, .threat, .rule, .mobile-card, .os-card, .vpn-card, .dimension-card, .theory-dimension, .theory-footer, .auth-item, .dns-item, .enc-tool, .tool-card');
    cards.forEach(card => {
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.card, .principle, .threat, .tip, .quiz-question, .comparison-table, .hardening-tips li, .os-card, .vpn-card, .provider-item, .iot-tip, .social-do, .social-dont, .social-threat, .wifi-risk, .phishing-sign, .step, .resource-link, .glossary-item, .ransomware-card, .type-card, .protection-item, .mobile-card, .right-item, .privacy-check, .rule, .manager, .bad-passwords, .mccumber-img, .dimension-card, .theory-dimension, .theory-footer, .auth-item, .dns-item, .enc-tool, .tool-card');
